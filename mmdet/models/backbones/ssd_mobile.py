...
from mmcv.cnn import (MobileNetV2, xavier_init, constant_init, kaiming_init,
                      normal_init)
...
class SSDMobile(MobileNetV2):
    ...
    def __init__(self,
        ...
        self.l2_norm = L2Norm(96, l2_norm_scale)
    ...
    def _make_extra_layers(self, outplanes):
        ...
        for i in range(len(outplanes)):
            ...
            conv = _conv_dw(self.inplanes, outplane, stride=2, padding=1, expand_ratio=1)
            layers.append(conv)
...
# A = SSDMobile(300).to(device)
# B = summary(A, (3, 300, 300))
# print(B)
